  ...
  "node_modules/@inertiajs/inertia-react/dist/index.js"(exports) {
    ...
    function s(e2) {
      ...
      if (r.useEffect(function() {
        ...
        return r.createElement(c.Provider, { value: v }, r.createElement(a.Provider, { value: p2.page }, null));
          ...
          return function e5(n3) {
            var r2 = function(e6) {
              var n4 = Object.keys(e6.props).reduce(function(n5, r3) {
                if (["head-key", "children", "dangerouslySetInnerHTML"].includes(r3))
                  return n5;
                var t2 = e6.props[r3];
    ...
    exports.App = s, exports.Head = l, exports.InertiaApp = s, exports.InertiaHead = l, exports.InertiaLink = d, exports.Link = d, exports.app = s, exports.createInertiaApp = function(e2) {
      try {
        ...
        return Promise.resolve(d2(p2.component).then(function(e3) {
          ...
          return function() {
            if (l2)
              return Promise.resolve(c2(r.createElement("div", { id: t2, "data-page": JSON.stringify(p2) }, e3))).then(function(e4) {
      ...
      var R = r.useCallback(function(e3, n2, r2) {
        ...
        var u2 = i({}, r2, { onCancelToken: function(e4) {
          if (f2.current = e4, r2.onCancelToken)
            return r2.onCancelToken(e4);
        }, onBefore: function(e4) {
          if (j(false), F(false), clearTimeout(p2.current), r2.onBefore)
            return r2.onBefore(e4);
        }, onStart: function(e4) {
          if (E(true), r2.onStart)
            return r2.onStart(e4);
        }, onProgress: function(e4) {
          if (I(e4), r2.onProgress)
            return r2.onProgress(e4);
        }, onSuccess: function(e4) {
          if (t2.current && (E(false), I(null), g({}), C(false), j(true), F(true), p2.current = setTimeout(function() {
            t2.current && F(false);
          }, 2e3)), r2.onSuccess)
            return r2.onSuccess(e4);
        }, onError: function(e4) {
          if (t2.current && (E(false), I(null), g(e4), C(true)), r2.onError)
            return r2.onError(e4);
        }, onCancel: function() {
          if (t2.current && (E(false), I(null)), r2.onCancel)
            return r2.onCancel();
        }, onFinish: function() {
          if (t2.current && (E(false), I(null)), f2.current = null, r2.onFinish)
            return r2.onFinish();
        } });
